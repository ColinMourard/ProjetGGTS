		...
		<div id="list-questionnaireCours" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="questionnaireCours.simple.label" default="Simple" /></th>
				...
				<g:each in="${questionnaireCoursInstanceList}" status="i" var="questionnaireCoursInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${questionnaireCoursInstance.id}">${fieldValue(bean: questionnaireCoursInstance, field: "simple")}</g:link></td>
