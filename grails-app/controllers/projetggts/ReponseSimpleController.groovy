...
class ReponseSimpleController {
    ...
    def save(ReponseSimple reponseSimpleInstance) {
		...
		questionnaire.moyenne =(int)100*(questionnaire.moyenne*(questionnaire.nombreDeReponses-1) + reponseSimpleInstance.reponse)/questionnaire.nombreDeReponses;
		questionnaire.moyenne = questionnaire.moyenne/100.0;
